        ...
        <section className="bg-gray-50 dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Discover How Veenote Boosts
                        Your Learning</h2>
                    <p className="font-light text-gray-500 dark:text-gray-400 sm:text-xl">Veenote empowers you to make the most of every
                        learning video by capturing key moments and insights. Explore the features designed to enhance focus, retention, and
                        organization in your learning journey.</p>
                </div>
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 xl:gap-8 md:space-y-0">
                    <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
                        ...
                        <p className="font-light text-gray-500 dark:text-gray-400">Plan it, create it, launch it. Collaborate seamlessly
                            with
                    ...
                    <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
                        ...
                        <p className="font-light text-gray-500 dark:text-gray-400">Protect your organization, devices and stay compliant
                            with
                    ...
                    <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
                        ...
                        <p className="font-light text-gray-500 dark:text-gray-400">Auto-assign tasks, send Slack messages, and much
                            more.
                            Now
                    ...
                    <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
                        ...
                        <p className="font-light text-gray-500 dark:text-gray-400">Audit-proof software built for critical financial
                            operations
                    ...
                    <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
                        ...
                        <p className="font-light text-gray-500 dark:text-gray-400">Craft beautiful, delightful experiences for both
                            marketing
                    ...
                    <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
                        ...
                        <p className="font-light text-gray-500 dark:text-gray-400">Keep your company’s lights on with customizable,
                            iterative,
